...
dt_referencia_inicio <- as.Date("2021-01-01")
dt_referencia_fim <- as.Date("2021-12-31")
...
cargos <- anvisa::agendas |>
  dplyr::select(pessoa = nome, cargo)

agendas_2021 <- agendas_anvisa |>
...
usethis::use_data(agendas_2021, overwrite = TRUE)
